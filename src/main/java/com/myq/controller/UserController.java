...
import com.myq.utils.PageHelper;
import com.myq.utils.UploadHelper;
...
public class UserController {
	...
	public String modifyPasswd(HttpSession session, Model md) {
		User user = (User) session.getAttribute(Constants.USER_SESSION);
		String userCode = user.getUserCode();
		md.addAttribute("userCode", userCode);
		return "modifyPasswd";
	}
	//添加用户处理方法
