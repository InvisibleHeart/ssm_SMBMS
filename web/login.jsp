...
<body class="loginpage">
	<div class="loginbox">
    	<div class="loginboxinner">
            ...
            <div class="logo">
            	<h1 class="logo">SMBMS<span>Order</span></h1>
				<span class="slogan" style="color: wheat">超市订单管理系统</span>
            </div><!--logo-->
...
<%--                </div><!--loginf-->--%>
<%--            </div><!--nopassword-->--%>
            <div c:if test="${pageContext.request.getParameter("msg") != null}">
                <span style="color: red">${pageContext.request.getParameter("msg")}</span>
            </div>
